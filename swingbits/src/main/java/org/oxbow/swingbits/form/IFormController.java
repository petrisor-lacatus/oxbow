package org.oxbow.swingbits.form;
...
//	IFormDecorator getFormDecorator();
	 ...
	 * immediately after step #1. This method should be used for time consuming
	 * tasks such as data loading. Progress animation is usually shown
	 * during execution of this method.
	 */
	void init();

	/**
	 * Initialization step #3. Executed on the EDT immediately after step #2 is
	 * done. Usually used to perform additional initialization after long
